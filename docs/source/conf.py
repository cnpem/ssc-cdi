...
autodoc_mock_imports = ["sscResolution","sscPtycho","sscPimega","sscRaft","cbf", "sscIO","sscRadon","ipywidgets"] # list all modules to be ignored during compilation of the html 
