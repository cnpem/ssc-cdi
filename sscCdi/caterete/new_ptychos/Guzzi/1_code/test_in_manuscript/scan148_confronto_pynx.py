...
diffpath = '/net/memory4twinmic/store/project/twinmic/scicomp/tesla-storage/software_paper_peerJ/data_real/cell148_new_darkcorr_autocropped_1250.tif'
...
pospath = '/net/memory4twinmic/store/project/twinmic/scicomp/tesla-storage/software_paper_peerJ/data_real/twinmic_scan_148.h5'
