...
# Example usage
volume1 = 100*np.random.rand(23, 10, 10) * np.exp(1j * np.random.rand(23, 10, 10))
volume2 = np.random.rand(55, 10, 10) * np.exp(1j * np.random.rand(55, 10, 10))
volume3 = np.random.rand(30, 10, 10) * np.exp(1j * np.random.rand(30, 10, 10))
volumes = [volume1, volume2, volume3]
visualizer_volumes(volumes)