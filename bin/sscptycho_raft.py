...
""" Select name of file with angles values"""
anglesFile = sinogram_folder + output_filesname + f'_angles.npy'
...
if processing_steps["Sort"]:
    ...
    print('Rois shape:',rois.shape,'Object shape:',object_temporary.shape)
